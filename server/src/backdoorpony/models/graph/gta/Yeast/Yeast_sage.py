...
#A model instance for the Yeast dataset that inherits from general graphcnn model.
class Yeast_sage(GraphSAGE):
    def __init__(self, model_parameters):
        ...
        super().__init__(102, 2, model_parameters["hidden_dim"]["value"], model_parameters["dropout"]["value"][0], 
