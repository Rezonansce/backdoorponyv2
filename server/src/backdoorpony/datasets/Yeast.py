'''
Load the Yeast dataset (graphs) for use in attacks and/or defences.
...
class Yeast(object):
    ...
    def get_data(self):
        '''
        Get the Yeast (Yeast) dataset, which consists of 79601 graphs. It contains two graph labels, 0 and 1.
        ...
        dr = DataReader(use_nlabel_asfeat = True, use_org_node_attr = False, use_degree_asfeat = True, 
                        data_path = d_path, dataset = "Yeast", seed = 42, data_verbose = False, train_ratio = 0.8, frac = self.frac)
