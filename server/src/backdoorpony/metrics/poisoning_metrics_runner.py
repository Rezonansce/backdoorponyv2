...
__class_name__ = 'PoisoningMetricsRunner'


class PoisoningMetricsRunner(AbstractMetricsRunner):

    def __init__(self, clean_accuracy, benign_inputs, benign_labels, dict_others):
        '''Initializes the poisoning-metrics-runner.
        Calculates appropriate metrics for poisoning attacks. Extends the AbstractMetricsRunner class.
